...
public class CreateStepMockServerTest {
    @Rule
    ...
    public void testPipelineCreate() {
        ...
        // When
        CreateStep createStep = new CreateStep(testPipelineYaml, CreateStep.InputType.YAML.toString());
        createStep.setTektonClient(client);
    ...
    public void testPipelineResourceCreate() {
        ...
        // When
        CreateStep createStep = new CreateStep(testPipelineResourceYaml, CreateStep.InputType.YAML.toString());
        createStep.setTektonClient(client);
